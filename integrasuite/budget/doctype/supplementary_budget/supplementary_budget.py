				...
				if to_account:
					...
					if monthly_budget:
						if month:
							if month =="January":
								if cancel:
									supplement = flt(to_budget_account.january) - flt(d.amount)
									to_budget_account.db_set("january", flt(supplement))
								else:
									supplement = flt(to_budget_account.january) + flt(d.amount)
									to_budget_account.db_set("january", flt(supplement))
							elif month =="Februery":
								if cancel:
									supplement = flt(to_budget_account.february) - flt(d.amount)
									to_budget_account.db_set("february", flt(supplement))
								else:
									supplement = flt(to_budget_account.february) + flt(d.amount)
									to_budget_account.db_set("february", flt(supplement))
							elif month =="March":
								if cancel:
									supplement = flt(to_budget_account.march) - flt(d.amount)
									to_budget_account.db_set("march", flt(supplement))
								else:
									supplement = flt(to_budget_account.march) + flt(d.amount)
									to_budget_account.db_set("march", flt(supplement))
							elif month =="April":
								if cancel:
									supplement = flt(to_budget_account.april) - flt(d.amount)
									to_budget_account.db_set("april", flt(supplement))
								else:
									supplement = flt(to_budget_account.april) + flt(d.amount)
									to_budget_account.db_set("april", flt(supplement))
							elif month =="May":
								if cancel:
									supplement = flt(to_budget_account.may) - flt(d.amount)
									to_budget_account.db_set("may", flt(supplement))
								else:
									supplement = flt(to_budget_account.may) + flt(d.amount)
									to_budget_account.db_set("may", flt(supplement))
							elif month =="June":
								if cancel:
									supplement = flt(to_budget_account.june) - flt(d.amount)
									to_budget_account.db_set("june", flt(supplement))
								else:
									supplement = flt(to_budget_account.june) + flt(d.amount)
									to_budget_account.db_set("june", flt(supplement))
							elif month =="July":
								...
								if cancel:
									supplement = flt(to_budget_account.september) - flt(d.amount)
									to_budget_account.db_set("september", flt(supplement))
								else:
									supplement = flt(to_budget_account.september) + flt(d.amount)
									to_budget_account.db_set("september", flt(supplement))
							elif month =="October":
								if cancel:
									supplement = flt(to_budget_account.october) - flt(d.amount)
									to_budget_account.db_set("october", flt(supplement))
								else:
									supplement = flt(to_budget_account.october) + flt(d.amount)
									to_budget_account.db_set("october", flt(supplement))
							elif month =="November":
								if cancel:
									supplement = flt(to_budget_account.november) - flt(d.amount)
									to_budget_account.db_set("november", flt(supplement))
								else:
									supplement = flt(to_budget_account.november) + flt(d.amount)
									to_budget_account.db_set("november", flt(supplement))
							else:
								if cancel:
									supplement = flt(to_budget_account.december) - flt(d.amount)
									to_budget_account.db_set("december", flt(supplement))
								else:
									supplement = flt(to_budget_account.december) + flt(d.amount)
									to_budget_account.db_set("december", flt(supplement))
						else:
