...
frappe.ui.form.on("Travel Authorization", {
	...
	make_travel_claim: function (frm) {
		let method = "integrasuite.integrasuite_hr.doctype.travel_claim.travel_claim.get_travel_claim";
		return frappe.call({
			method: method,
			args: {
				dt: frm.doc.doctype,
	...
	make_travel_adjustment: function (frm) {
		frappe.model.open_mapped_doc({
			method: "integrasuite.integrasuite_hr.doctype.travel_adjustment.travel_adjustment.make_travel_adjustment",
			frm: cur_frm,
		});
	},
	...
	get_employee_currency: function (frm) {
        ...
        frappe.db.get_list("Salary Structure Assignment", {
            ...
            if (assignments && assignments.length > 0) {
                ...
                // No Salary Structure Assignment found
                frm.set_value(
                    "currency",
                    erpnext.get_currency(frm.doc.company)
                );
